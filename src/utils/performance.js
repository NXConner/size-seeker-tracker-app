...
const lazyLoad = (importFunc, fallback) => {
    ...
    return (props) => (react_1.default.createElement(react_1.default.Suspense, { fallback: fallback ? react_1.default.createElement(fallback) : react_1.default.createElement('div', null, 'Loading...') }, react_1.default.createElement(LazyComponent, { ...props })));
};
